...
#define ARGS_CHECK(argc,num) {if(argc != num){fprintf(stdout,"agrs error!\n"); return -1;}}

#define ERROR_CHECK(ret,num,msg){if(num == ret){perror(msg); return -1;}}
...
int main(int argc,char* argv[])
{
  ...
  ERROR_CHECK(fdw,-1,"open fdw error!\n");
